...
overlay.innerHTML='<div class="visitor-hud"><strong>VISITOR MODE</strong><span>WASD / ARROWS · MOUSE LOOK · CLICK DOORS</span></div><button class="visitor-exit" type="button">EXIT WALKTHROUGH</button><div class="visitor-crosshair">+</div>';
...
.visitor-house-overlay.active{opacity:1}.visitor-hud{position:absolute;top:18px;left:50%;transform:translateX(-50%);display:flex;gap:16px;align-items:center;padding:9px 14px;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:rgba(3,5,11,.7);backdrop-filter:blur(12px);font:700 9px Inter,sans-serif;letter-spacing:1.5px;color:#9aa8bc;white-space:nowrap}.visitor-hud strong{color:#67e8f9}.visitor-exit{position:absolute;right:18px;top:18px;pointer-events:auto;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:rgba(3,5,11,.7);color:#fff;padding:9px 13px;font:700 9px Inter,sans-serif;letter-spacing:1px;cursor:pointer}.visitor-crosshair{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font:300 24px/1 Inter;color:rgba(255,255,255,.65)}
body.visitor-mode{overflow:hidden}.visitor-mode main{height:100svh;overflow:hidden}.visitor-mode main section.room{position:absolute;inset:0;margin:0;min-height:100svh;opacity:0;visibility:hidden;pointer-events:none;transform:translate3d(0,0,-180px) scale(.92);transition:opacity .55s,transform .8s,visibility .55s}.visitor-mode main section.room.visitor-current{opacity:1;visibility:visible;pointer-events:auto;transform:translate3d(0,0,0) scale(1)}.visitor-mode .topbar,.visitor-mode .room-nav,.visitor-mode .scroll-progress,.visitor-mode .camera-readout{z-index:10000}.visitor-mode .house-hero{display:block}
